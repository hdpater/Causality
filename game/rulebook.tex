...
\step{Caught}{Deduct one white cube's worth, \keyword{6}, for each time you were assayed and found light. An assay can only catch you on a round you struck light, so it is always a white cube being cancelled. It does not matter which.}
...
\note{On winning}{Nobody knows the scores until the jars come out, which is the point. The winner is usually somebody who struck full weight most rounds, called an assay or two, and was believed. The second most common winner is somebody who lied twice, very early, and was never challenged for it. Both should feel earned.}
