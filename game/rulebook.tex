...
12 Margin tokens & Worth 10 Profit each. \\
...
If the Light Count was \keyword{2 or lower}, the city has had a quiet round. Shuffle the retained cubes of every player who struck full weight, draw one at random, and award that player a \keyword{Margin token}.

Then every player drops both retained cubes into the Melt bag, which now holds exactly ten white and ten black. Tip it out, redistribute two of each colour to every player, and pass the First Player marker clockwise.
...
\step{Benefit}{Members gain \keyword{+1 Profit} on every full-weight striking.}
\step{Tariff}{Non-members pay \keyword{1 Profit} to the bank whenever they trade with a member.}
...
\note{On winning}{The winner is usually somebody who struck full weight, policed the table, and was believed. The second most common winner is somebody who lied twice, very early, and was never challenged for it. Both should feel earned.}
...
\step{6.}{\keyword{Erosion.} Trust drops by the Count. All cubes back to the bag.}
