...
One player keeps it, in full view, and everybody can correct it. Each round, record: the Light Count, the new Trust total and therefore the tier, who called an assay, whom they named, and what was found. Also note who is in the Standard.
...
Work through the round log together, round by round, reading each player's cube for that round against the tier that was in force. Nothing here is private any more, and nothing has to be taken on anybody's word.

\step{Full weight}{A black cube. Score \keyword{2}, plus \keyword{3} banked for having struck sound.}
\step{Light}{A white cube. Score the false-striking rate for that round's tier: 6, 5, 4 or 3.}
\step{Caught}{A round in which you were assayed and found light scores you \keyword{nothing}. The log says which round it was.}
\step{Assays called}{\keyword{3} for each one you called correctly.}
\step{Standard}{\keyword{+1} for each round you were a member, and \keyword{-1} for each round you were not. \keyword{+5} if it is still standing at the end.}
