...
\begin{tabular}{@{}llcc@{}}
\toprule
\headfont What you did & \headfont Cube in tube & \headfont Before the Turn & \headfont After the Turn \\
\midrule
Struck full weight & black & 5 & 5 \\
Struck light & white & 6 & 3 \\
\bottomrule
\end{tabular}
\end{center}
...
Striking light pays better than striking sound, which is the whole difficulty, but only while the coinage is healthy. After the Turn it pays 3 against honest work's 5, and the House that keeps clipping is paying for the privilege of finishing the job.
...
\step{Black cube}{You struck full weight. \keyword{5}, whenever it was.}
\step{White cube}{You struck light. \keyword{6} if the round was before the Turn, \keyword{3} if after.}
...
\begin{tabular}{@{}llcc@{}}
\toprule
\headfont You & \headfont Tube & \headfont Before Turn & \headfont After Turn \\
\midrule
struck full weight & black & 5 & 5 \\
struck light & white & 6 & 3 \\
\bottomrule
...
The cube in your tube is the \emph{opposite} of what you struck.}
\end{center}
