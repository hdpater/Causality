...
\begin{tabular}{@{}llc@{}}
\toprule
\headfont What you did & \headfont Cube in tube & \headfont Worth \\
\midrule
Struck full weight & black & 5 \\
Struck light & white & 6 \\
\bottomrule
\end{tabular}
\end{center}

\note{The cube is the opposite of what you did}{You played one cube and kept the other, so the cube in your tube is always the reverse of your striking. \keyword{Black in the tube means you were honest.} It catches everybody out at least once, so read the left-hand column, not the colour.}

Striking light is worth one more than striking sound, every round, from first to last. It is never the safe choice and never the pointless one.

That single point is smaller than it looks. A House that clips once and is never assayed has gained almost nothing. A House that clips every round has gained twelve, which wins games, and has also given the table eleven more chances to catch it.
...
Everything from here is public, and nothing has to be taken on anybody's word. Count each player's cubes: five for every black, six for every white.

\step{Black cube}{You struck full weight. \keyword{5}.}
\step{White cube}{You struck light. \keyword{6}.}
...
\begin{tabular}{@{}llc@{}}
\toprule
\headfont You & \headfont Tube & \headfont Worth \\
\midrule
struck full weight & black & 5 \\
struck light & white & 6 \\
\bottomrule
...
{\itshape The cube in your tube is the \emph{opposite} of what you struck.\\
