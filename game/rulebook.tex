...
\step{2.}{Give each player one white and one black coin, one cup, one jar, one screen and one player aid.}
\step{3.}{Put 16 white and 4 black coins in the Silver bag. Leave the Till empty.}
