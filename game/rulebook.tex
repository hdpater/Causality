...
Keep this second retained cube \emph{hidden in your fist}. Do not set it down, and do not let anybody see it.

\note{Why this one stays hidden}{Your retained silver cube is white exactly when you played black, which is to say exactly when your silver came in bad. Anybody who saw it would know that one of the round's black cubes was nobody's fault. If they saw everybody's, they could subtract the whole of the bad silver from the Light Count and read off precisely how many Houses struck light on purpose, which is the one thing the game must never let them do.}
...
Then, on a count of three and all together, every player drops their remaining cubes into the supply with a closed hand. Doing it at once and unseen matters: it is the last moment at which anybody could learn who was sold bad silver.

Redistribute two white and two black to each player, and pass the First Player marker clockwise.
