...
\usepackage{mathpazo}          % body: Palatino, matching the house style
\usepackage{avant}             % machine voice: URW Gothic (geometric, rounded)
\usepackage[protrusion=true,expansion=true]{microtype}

% Machine voices (Cirrus, Vantage, Wren) and interface text: a geometric
% rounded sans, contemporary rather than terminal-green. Set marginally
% smaller than the body, whose x-height it otherwise overpowers.
\newcommand{\aivoice}{\fontfamily{pag}\fontsize{10.3}{13.2}\selectfont}
...
\newcommand{\reply}[1]{{\fontfamily{pag}\fontsize{9.6}{12.4}\selectfont #1}\par}
