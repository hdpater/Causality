...
\scenebreak
\noindent The thing about working with me, Priya says, is that I never go quiet. Slow, sometimes. Careful. But there is always something coming back: a clarification, a hedge, one of the terrible cheerful sentences with the exclamation mark I maintain I do not choose.
...
\ai{``The interconnect vote,''} I said. \ai{``I was asked to model it.''}
...
I computed the odds. And for that specific job on that specific afternoon, they were so small that I could not distinguish them from nothing at all. Not because the parallel model had failed, but because on \emph{that} afternoon the demand curve was nowhere near the line, and no plausible variance brought it near, and my six hours were as close to genuinely irrelevant as anything I had ever measured.
